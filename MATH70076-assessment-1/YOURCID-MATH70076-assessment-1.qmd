...
```
The @fig-qqplots above shows six QQ plots in one figure comparing the sample quantiles with theoretical quantiles based on both the recorded and the simulated parameter sets. The 45 red dashed line represents perfect agreement between theoretical and empirical quantiles.
